...
map('n', '<leader>sB', function() Snacks.picker.lines() end, { desc = 'Buffers Lines' })
...
map('n', '<leader>sw', function() Snacks.picker.grep_word() end, { desc = 'Visual selection search' })
...
map('n', 'gt',         function() Snacks.picker.lsp_type_definitions() end, { desc = 'Goto Type Definition' })
